      ...
      <div className='relative w-[500px] lg:w-[700px]'>
        ...
        >
          ...
          <div className='absolute inset-0'>
            <img className='w-full h-full object-cover' src="before-1.webp" alt={t('beforeAlt')} draggable={false} />
          ...
          >
            <img className='w-full h-full object-cover' src="after-1.webp" alt={t('afterAlt')} draggable={false} />
